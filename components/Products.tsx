    ...
    <div
      ...
      <FadeIn delay={0.2} direction="right">
        <div className="flex flex-col">
          <h1 className="text-center 2xl:text-start text-fontBlack text-5xl lg:text-[64px] font-medium mb-6">Best Selling Products</h1>
          <button
            ...
            <h5 className="text-lg lg:text-xl text-[#4F4F4F] font-medium">See Colection</h5>
      ...
      <div className="w-full flex flex-col md:flex-row gap-[160px] md:gap-6">
        {PRODUCTS.map((product, i) => (
          <FadeIn key={i} delay={(i + 1) * 0.2} direction="left" className="w-full flex justify-center">
